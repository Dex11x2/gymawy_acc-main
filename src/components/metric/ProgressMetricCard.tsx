    ...
    return (
      <div className={shell} aria-busy="true">
        <div className={`flex flex-1 flex-col ${sz.pad}`}>
          ...
          <div className="mt-6 h-14 w-48 animate-pulse rounded-lg bg-gray-200 dark:bg-gray-800" />
          <div className="mt-auto h-24 w-full animate-pulse rounded-lg bg-gray-200/50 dark:bg-gray-800/50" />
        </div>
        <div className={`border-t border-gray-200 dark:border-gray-800 ${sz.footer}`}>
      ...
      <div className={shell}>
        <div className={`flex flex-1 flex-col ${sz.pad}`}>
          ...
          <div className="flex flex-1 flex-col items-center justify-center gap-1 py-10 text-center">
            <p className="text-sm font-medium text-gray-900 dark:text-white">لا توجد بيانات كافية</p>
            <p className="text-xs text-gray-500 dark:text-gray-400">هتظهر المقاييس أول ما تتوفر بيانات.</p>
          </div>
        </div>
      </div>
    );
      ...
      <div className={`pointer-events-none relative z-10 flex flex-1 flex-col ${sz.pad}`}>
        ...
        {isMulti && (
          <div className="mt-2.5 flex flex-wrap items-center gap-x-4 gap-y-1">
            {chartSeries.map((s) => (
              <span key={s.name} className="flex items-center gap-1.5 text-[12px] text-gray-500 dark:text-gray-400">
