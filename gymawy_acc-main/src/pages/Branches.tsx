...
const Branches: React.FC = () => {
  ...
  const getAllPages = () => {
    return [
      ...
      { module: 'payroll', name: 'الرواتب', nameEn: 'Payroll', actions: ['view', 'write', 'delete'] },
      ...
      { module: 'ads_funding', name: 'تقرير تمويل الإعلانات', nameEn: 'Ads Funding Report', actions: ['view', 'write'] },
